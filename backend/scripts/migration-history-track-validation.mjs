...
export const FUTURE_MIGRATION_PROBE = 'MigrationHistoryProbe2026092000010';
...
class MigrationHistoryProbe2026092000010 {
...
export async function runMigrationHistoryTrackValidation(mode, env = process.env) {
  ...
  const migrations =
    mode === 'existing'
      ? [...runtimeMigrations, MigrationHistoryProbe2026092000010]
      : [
          loadInitialBaseline(require),
          ...runtimeMigrations,
          MigrationHistoryProbe2026092000010,
        ];
