...
export const FUTURE_MIGRATION_PROBE = 'MigrationHistoryProbe2026090100010';
...
function loadRuntimeMigrations(require) {
  ...
  const {
    AddManualBookingGuestName2026083000010,
  } = require('../dist/migrations/2026083000010-AddManualBookingGuestName.js');
...
class MigrationHistoryProbe2026090100010 {
...
export async function runMigrationHistoryTrackValidation(mode, env = process.env) {
  ...
  const migrations =
    mode === 'existing'
      ? [...runtimeMigrations, MigrationHistoryProbe2026090100010]
      : [
          loadInitialBaseline(require),
          ...runtimeMigrations,
          MigrationHistoryProbe2026090100010,
        ];
