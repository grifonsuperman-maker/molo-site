...
export class Restaurant {
  ...
  @Column({ name: 'main_photo_url', type: 'text', nullable: true }) mainPhotoUrl: string | null;
  @Column({ name: 'open_time', type: 'time', default: '10:00' }) openTime: string;
  ...
  @Column({ name: 'map_height', type: 'numeric', default: 1000 }) mapHeight: number;
  @Column({ name: 'booking_close_notified_at', type: 'date', nullable: true }) bookingCloseNotifiedAt: string | null;
  @Column({ name: 'restaurant_close_notified_at', type: 'date', nullable: true }) restaurantCloseNotifiedAt: string | null;
